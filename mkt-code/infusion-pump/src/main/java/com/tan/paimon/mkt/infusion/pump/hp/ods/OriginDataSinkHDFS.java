...
import com.tan.paimon.mkt.infusion.pump.utils.FlinkStreamingSinkFileUtils;
 ...
 * 麦科田解析数据 sink 到 HDFS
 */
public class OriginDataSinkHDFS {

    private static final Logger LOG = LoggerFactory.getLogger(OriginDataSinkHDFS.class);
