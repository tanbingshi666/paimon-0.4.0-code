...
/**
 * 关于 Paimon Primary Key Table Changelog Producer Is full-compaction 说明
 * 1 会产生完整的 changelog
 ...
 */
public class PrimaryKeyTableWithChangelogProduce_FullCompaction {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE IF NOT EXISTS ods_kafka_source_hp_series_full (\n" +
                "  `factory_num` STRING,\n" +
                "  `equ_type` STRING,\n" +
                "  `equ_num` STRING,\n" +
                "  `work_sta` STRING,\n" +
        ...
        tableEnv.executeSql("INSERT INTO ods_kafka_source_hp_series_full SELECT \n" +
                "\n" +
